...
def detect_face_from_video(video_path: str) -> bytearray:
    ...
    if not os.path.isfile(video_path):
        print('mocr:face_detection:detect_face_from_video No video found on given video path!')
        return None
    ...
    if len(faces) == 0 or len(faces) > 1:
        print('mocr:face_detection:detect_face_from_video Video should does not contain a face!')
        return None
